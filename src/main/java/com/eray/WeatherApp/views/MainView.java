package com.eray.WeatherApp.views;
...
import com.eray.WeatherApp.controller.WeatherService;
...
public class MainView<cityName> extends UI {
    ...
    private void setHeader(){
        ...
        Label Title = new Label("Weather Application By Eray Nacarlı");
    ...
    private void setLogo() {
        ...
        logo.setSource(new ClassResource("/static/logo.png"));
        logo.setWidth("240px");
    ...
    private void footer(){
        ...
        description.setValue("Weather App by Eray Nacarlı . Visit my Github Repository. https://github.com/eraynaccarli/WeatherApiApplication ");
